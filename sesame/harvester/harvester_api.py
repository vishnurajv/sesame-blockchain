...
from sesame.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from sesame.harvester.harvester import Harvester
from sesame.plotting.plot_tools import PlotInfo, parse_plot_info
from sesame.protocols import harvester_protocol
from sesame.protocols.farmer_protocol import FarmingInfo
from sesame.protocols.protocol_message_types import ProtocolMessageTypes
from sesame.server.outbound_message import make_msg
...
from sesame.util.api_decorators import api_request, peer_required
from sesame.util.ints import uint8, uint32, uint64
from sesame.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSesameConnection
    ):
        """
