...
from sesame.types.blockchain_format.program import Program, INFINITE_COST
from sesame.types.condition_opcodes import ConditionOpcode
from sesame.types.spend_bundle import SpendBundle
from sesame.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "sesame" in cc_discrepancies:
                    cc_discrepancies["sesame"] = cc_discrepancies["sesame"] + diff
                else:
                    cc_discrepancies["sesame"] = diff
