...
from sesame.types.announcement import Announcement
...
from sesame.wallet.puzzles.puzzle_utils import (
...
from sesame.wallet.secret_key_store import SecretKeyStore
from sesame.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_sesame(self, sesame_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if sesame_amount < 0:
            utxos = await self.select_coins(abs(sesame_amount), exclude)
        else:
        ...
        sesame_amount = spend_value + sesame_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": sesame_amount}]
