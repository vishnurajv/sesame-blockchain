...
address2 = "txch1c2cguswhvmdyz9hr3q6hak2h6p9dw4rz82g4707k2xy2sarv705qcce4pn"  # Change address (m/12381/8444/2/0)
...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_sesame += int_from_bytes(cvp.vars[1])
            print(
...
total_sesame = 0
print("Pool address: ")
total_sesame += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_sesame += make_puzzle(farmer_amounts)

assert total_sesame == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
