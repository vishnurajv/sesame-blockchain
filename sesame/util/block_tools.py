...
from sesame.cmds.init_funcs import create_all_ssl, create_default_sesame_config
from sesame.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from sesame.plotting.create_plots import create_plots
from sesame.consensus.block_creation import create_unfinished_block, unfinished_block_to_full_block
from sesame.consensus.block_record import BlockRecord
from sesame.consensus.blockchain_interface import BlockchainInterface
...
from sesame.consensus.deficit import calculate_deficit
from sesame.consensus.full_block_to_block_record import block_to_block_record
from sesame.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from sesame.consensus.pot_iterations import (
    calculate_ip_iters,
...
from sesame.consensus.vdf_info_computation import get_signage_point_vdf_info
from sesame.full_node.signage_point import SignagePoint
from sesame.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from sesame.types.blockchain_format.proof_of_space import ProofOfSpace
from sesame.types.blockchain_format.sized_bytes import bytes32
from sesame.types.blockchain_format.slots import (
...
from sesame.types.blockchain_format.vdf import VDFInfo, VDFProof
from sesame.types.end_of_slot_bundle import EndOfSubSlotBundle
from sesame.types.full_block import FullBlock
from sesame.types.generator_types import BlockGenerator, CompressorArg
...
from sesame.util.block_cache import BlockCache
from sesame.util.config import load_config, save_config
from sesame.util.hash import std_hash
from sesame.util.ints import uint8, uint32, uint64, uint128
from sesame.util.keychain import Keychain, bytes_to_mnemonic
...
from sesame.wallet.derive_keys import (
...
class BlockTools:
    ...
    def __init__(
        ...
        if len(self.pool_pubkeys) == 0 or len(farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `sesame generate keys`")
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xsm")
...
def get_plot_dir() -> Path:
    cache_path = Path(os.path.expanduser(os.getenv("SESAME_ROOT", "~/.sesame/"))) / "test-plots"
    mkdir(cache_path)
    return cache_path
