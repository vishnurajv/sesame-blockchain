...
from sesame.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "54444"
            testnet_introducer = "beta1_introducer.sesamechain.network"
            testnet = "testnet7"
            ...
            mainnet_port = "4444"
            mainnet_introducer = "introducer.sesamechain.network"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running sesame services for changes to take effect")
