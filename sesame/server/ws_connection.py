...
from sesame.cmds.init_funcs import sesame_full_version_str
from sesame.protocols.protocol_message_types import ProtocolMessageTypes
from sesame.protocols.shared_protocol import Capability, Handshake
...
from sesame.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from sesame.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSSesameConnection:
    """
