...
from sesame.protocols.full_node_protocol import RespondBlock
from sesame.server.server import SesameServer
from sesame.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
from sesame.types.peer_info import PeerInfo
from sesame.util.ints import uint16, uint32, uint64
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSSesameConnection] = wallet.server.get_outgoing_connections()
