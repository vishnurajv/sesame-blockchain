...
from sesame.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from sesame.protocols import farmer_protocol
from sesame.rpc.farmer_rpc_api import FarmerRpcApi
from sesame.rpc.farmer_rpc_client import FarmerRpcClient
from sesame.rpc.harvester_rpc_api import HarvesterRpcApi
from sesame.rpc.harvester_rpc_client import HarvesterRpcClient
...
from sesame.util.block_tools import get_plot_dir
...
from sesame.wallet.derive_keys import master_sk_to_wallet_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xsm"), encode_puzzle_hash(new_ph_2, "xsm"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xsm"))
            ...
            assert config["farmer"]["xsm_target_address"] == encode_puzzle_hash(new_ph, "xsm")
            assert config["pool"]["xsm_target_address"] == encode_puzzle_hash(new_ph_3, "xsm")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xsm")
