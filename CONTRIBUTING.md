...
It also includes a verifiable delay function implementation that it imports from the [sesamevdf repo](https://github.com/Sesame-Network/sesamevdf) (in c/c++), and a proof of space implementation that it imports from the [sesamepos repo](https://github.com/Sesame-Network/sesamepos). BLS signatures are imported from the [bls-signatures repo](https://github.com/Sesame-Network/bls-signatures) as blspy. There is an additional dependency on the [sesamebip158 repo](https://github.com/Sesame-Network/sesamebip158). For major platforms, binary and source wheels are shipped to PyPI from each dependent repo. Then sesame-blockchain can pip install those from PyPI or they can be prepackaged as is done for the Windows installer. On unsupported platforms, pip will fall back to the source distributions, to be compiled locally.
